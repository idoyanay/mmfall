...
weighted_configs = [
    ...
    ('radar w p=1,s=1.5', 'velocity', False, 1.0, 1.0, 'y'),
    ('radar w p=1.5, s=3','velocity', True,  3,   1.5, 'r'),
    ('radar w p=1,s=3.0', 'velocity', True,  3.0, 1.0, 'b'),
    ('radar w p=2,s=2.0', 'velocity', True,  2.0, 2.0, 'c'),
    ('radar w p=1,s=3.5', 'velocity', True,  3.5, 1.0, 'g'),
    ('radar w p=2,s=1.5', 'velocity', True,  1.5, 2.0, 'm'),
]
